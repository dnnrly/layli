...
func TestAbsoluteFromSvg(t *testing.T) {
	...
	t.Run("Nodes and edges are read in order", func(t *testing.T) {
...
<svg width="380" height="300"
	...
	<g style="text-anchor:middle;font-family:sans;fill:none;stroke:black">
		...
		<rect x="60" y="60" width="80" height="40" rx="3" ry="3" id="a"   data-order="0" data-pos-x="3" data-pos-y="3" data-width="5" data-height="3" />
		<text x="100" y="80" id="a-text" style="font-size:10px" >First</text>
		<rect x="240" y="60" width="80" height="40" rx="3" ry="3" id="c"   data-order="1" data-pos-x="12" data-pos-y="3" data-width="5" data-height="3" />
		<text x="280" y="80" id="c-text" style="font-size:10px" >Third</text>
		<rect x="60" y="200" width="80" height="40" rx="3" ry="3" id="b"   data-order="2" data-pos-x="3" data-pos-y="10" data-width="5" data-height="3" />
		<text x="100" y="220" id="b-text" style="font-size:10px" >Second</text>
		<path d="M 100 200 L 100 100" id="edge-1" class="path-line"  marker-end="url(#arrow)" data-from="b" data-to="a" data-order="0" />
		<path d="M 140 220 L 260 220 L 260 100" id="edge-2" class="path-line"  marker-end="url(#arrow)" data-from="b" data-to="c" data-order="1" />
	</g>
</svg>
`, Config{
			Nodes: ConfigNodes{
				ConfigNode{Id: "a", Contents: "First", Position: Position{X: 3, Y: 3}},
				ConfigNode{Id: "c", Contents: "Third", Position: Position{X: 12, Y: 3}},
				ConfigNode{Id: "b", Contents: "Second", Position: Position{X: 3, Y: 10}},
			},
			Edges: ConfigEdges{
				ConfigEdge{From: "b", To: "a"},
